...
interpret (Ann (_, POp op a b)) = do
  ...
  pure $ do
    ...
    case (op, a, b) of
      ...
      (C.Shl, VNumber (C.I32 a), VNumber (C.I32 b)) -> pure $ VNumber $ C.I32 (a `shiftL` b)
      (C.Shr, VNumber (C.I32 a), VNumber (C.I32 b)) -> pure $ VNumber $ C.I32 (a `shiftR` b)
      (C.Rotl, VNumber (C.I32 a), VNumber (C.I32 b)) -> pure $ VNumber $ C.I32 (a `rotateL` b)
      (C.Rotr, VNumber (C.I32 a), VNumber (C.I32 b)) -> pure $ VNumber $ C.I32 (a `rotateR` b)
      ...
      (C.Shl, VNumber (C.I64 a), VNumber (C.I64 b)) -> pure $ VNumber $ C.I64 (a `shiftL` b)
      (C.Shr, VNumber (C.I64 a), VNumber (C.I64 b)) -> pure $ VNumber $ C.I64 (a `shiftR` b)
      (C.Rotl, VNumber (C.I64 a), VNumber (C.I64 b)) -> pure $ VNumber $ C.I64 (a `rotateL` b)
      (C.Rotr, VNumber (C.I64 a), VNumber (C.I64 b)) -> pure $ VNumber $ C.I64 (a `rotateR` b)
