...
import qualified OSC.Codegen.Interpret as I
...
et10 = EApp (TNumber TI64) (EAbs (TAbs [] (TNumber TI64)) [] [] (EApp (TNumber TI64) (EAbs (TAbs [TNumber TI64,TNumber TI64] (TNumber TI64)) [Ident "z984",Ident "z765"] [(Ident "x69",EArr (TArr (TAbs [TNumber TF64] (TNumber TF32)) 4) [EAbs (TAbs [TNumber TF64] (TNumber TF32)) [Ident "g732"] [] (EConst (F32 0.0)),EAbs (TAbs [TNumber TF64] (TNumber TF32)) [Ident "f452"] [(Ident "c544",EConst (I64 1))] (EConst (F32 0.16111821)),EAbs (TAbs [TNumber TF64] (TNumber TF32)) [Ident "g39"] [] (EConst (F32 0.0)),EAbs (TAbs [TNumber TF64] (TNumber TF32)) [Ident "y117"] [(Ident "y293",EConst (F64 0.2243793578441271))] (EConst (F32 1.0))])] (ERec (TNumber TI64) 2 (Ident "z895") [(Ident "c395",EApp (TAbs [TAbs [TNumber TF64] (TNumber TI64),TNumber TF32,TNumber TI64] (TNumber TF32)) (EAbs (TAbs [TAbs [TNumber TI64,TNumber TF64,TNumber TF64] (TNumber TI32),TNumber TI64] (TAbs [TAbs [TNumber TF64] (TNumber TI64),TNumber TF32,TNumber TI64] (TNumber TF32))) [Ident "x892",Ident "a371"] [(Ident "g168",EVar (TNumber TI64) (Ident "a371")),(Ident "z663",EArr (TArr (TNumber TI64) 4) [EVar (TNumber TI64) (Ident "a371"),EConst (I64 (-1)),EVar (TNumber TI64) (Ident "z984"),EConst (I64 1)])] (EAbs (TAbs [TAbs [TNumber TF64] (TNumber TI64),TNumber TF32,TNumber TI64] (TNumber TF32)) [Ident "z357",Ident "a715",Ident "y55"] [(Ident "a134",EAbs (TAbs [TNumber TF32,TNumber TF64] (TNumber TF64)) [Ident "y403",Ident "a604"] [(Ident "c29",EAbs (TAbs [TNumber TI64] (TNumber TI32)) [Ident "g305"] [(Ident "b792",EArr (TArr (TNumber TF32) 3) [EConst (F32 1.0),EConst (F32 0.54651535),EConst (F32 (-1.0))])] (EConst (I32 1))),(Ident "f792",EConst (F32 1.5)),(Ident "z410",EConst (I32 1))] (EConst (F64 (-1.0)))),(Ident "a468",EConst (I64 2)),(Ident "z148",EArr (TArr (TNumber TI32) 5) [EConst (I32 2),EConst (I32 0),EConst (I32 1),EConst (I32 1),EConst (I32 1)])] (EConst (F32 0.24038458)))) [EAbs (TAbs [TNumber TI64,TNumber TF64,TNumber TF64] (TNumber TI32)) [Ident "g146",Ident "y802",Ident "z539"] [] (EConst (I32 (-1))),EConst (I64 1)]),(Ident "z560",EApp (TNumber TI64) (EAbs (TAbs [TNumber TF32] (TNumber TI64)) [Ident "y143"] [] (EConst (I64 (-1)))) [EConst (F32 0.51468956)]),(Ident "z684",EConst (F64 0.5))] (EOp (TNumber TI64) Add (EVar (TNumber TI64) (Ident "z765")) (EVar (TNumber TI64) (Ident "z895"))))) [EConst (I64 (-3)),ESelect (TNumber TI64) (EApp (TArr (TNumber TI64) 5) (EAbs (TAbs [] (TArr (TNumber TI64) 5)) [] [(Ident "c277",EConst (I32 (-1))),(Ident "f909",EConst (I64 1))] (EArr (TArr (TNumber TI64) 5) [EConst (I64 1),EVar (TNumber TI64) (Ident "f909"),EConst (I64 1),EVar (TNumber TI64) (Ident "f909"),EConst (I64 (-1))])) []) (EConst (I64 3))])) []
...
showBytecode et = do
  ...
  where
    Right et' = infer et
    ces = toCExpr et'
    (_, funcRefMap, genv) = compileExpr ces
    ir = toplevel genv.globals funcRefMap
...
letsee :: Expr () -> [I.Value]
letsee e = I.interpretToList 20 ir (exprType et) fr
  where
    Right et = infer e

    et' = case et of
      EAbs _ _ _ _ -> et
      _ -> EAbs (TAbs [] (exprType et)) [] [] et
